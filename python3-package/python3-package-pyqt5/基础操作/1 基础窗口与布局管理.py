...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # 设置窗口属性
        self.setWindowTitle("PyQt5 综合示例")
    ...
    def create_data_tab(self):
        ...
        data_label.setFont(QFont("Arial", 12, QFont.Bold))  # 标题加粗
        layout.addWidget(data_label)

        # 表格占位符（实际项目中可用QTableWidget）
        table_placeholder = QLabel("此处将显示数据表格")
        table_placeholder.setAlignment(Qt.AlignCenter)  # 文本居中
        # 设置样式：背景色、边框、最小高度
    ...
    def show_about(self):
        """显示关于信息"""
        # 实际应用中会显示关于对话框
        self.status_bar.showMessage("PyQt5 示例应用 v1.0 © 2023", 5000)
