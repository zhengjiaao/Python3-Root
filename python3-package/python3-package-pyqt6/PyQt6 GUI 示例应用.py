...
class PyQtGUIApp(QMainWindow):
    def __init__(self):
        ...
        # 设置窗口标题和大小
        self.setWindowTitle("PyQt6 GUI 示例")
        ...
        # 创建标签控件
        title_label = QLabel("PyQt6 GUI 应用示例")
        font = QFont("Arial", 16)
        font.setBold(True)
        ...
        about_label = QLabel("PyQt6 GUI 示例应用\n\n"
                             "本示例展示了PyQt6中常用的GUI控件和功能，包括：\n"
                             "- 文本输入框、按钮、标签等基本控件\n"
                             "- 单选按钮、复选框、下拉列表等选择控件\n"
                             "- 进度条、滑块等进度控件\n"
                             "- 列表控件和操作\n"
                             "- 日期时间选择器\n"
                             "- 消息对话框和文件对话框\n\n"
                             "PyQt6是一个强大的Python GUI框架，可用于创建跨平台的桌面应用程序。")
    ...
    def display_inputs(self):
        ...
        text += f"小数: {self.double_spin.value():.1f}\n"
